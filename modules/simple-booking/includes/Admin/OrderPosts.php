...
?>
    ...
    public function bookable_order_meta_fields()
    {
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    <th scope="row"><label for="bookable_order_date">Product</label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="bookable_order_date">Date</label></th>
                ...
                <tr>
                    <th scope="row"><label for="bookable_order_time">Time</label></th>
                ...
                <tr>
                    <th scope="row"><label for="bookable_order_status">Status</label></th>
                    <td>
